$(function(){
    ...
    var sArea = $('#progressBar');                  // 进度条部分
    var insTime = $('#mouseTime');              // 鼠标移动至进度条上面，显示的信息部分
    var sHover = $('#mouseHoverProgressBar');                // 鼠标移动至进度条上面，前面变暗的进度条部分
    var seekBar = $('#currentProgressLocation');              // 播放进度条部分
